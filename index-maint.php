...
<body>
    ...
    <?php include('includes/pages/top_nav_maint.html'); ?>
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-center">New Home Of The Dingocoin Project</p> 
                            <p class="text-center"><br>Dingocoin.com is undergoing some system upgrades at this time. </p>
