    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/data1/images/hcharts.jpg"
                    alt="Charts & Exchanges Header">
            </div>
        </div>
    </div>
    <?php
        ...
        echo '<div class="container-xxl py-5">
	                <div class="container">
                        <div class="text-center mx-auto  fadeInUp" data--delay="0.1s" style="max-width: 500px;">
                            <h1 class="display-6">Charts & Exchanges</h1>
                        </div>
                        <div class="row justify-content-center text-center">
                            <span>Charts & Exchanges Module Loading ......<br> <small>Error: std-dxQH1</small></span>
                        </div> 
                    </div>
                  </div>
                 ';
