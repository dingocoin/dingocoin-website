...
<head>
    ...
    <title>Dingocoin | Community Projects</title>
...
<body>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/data1/images/hcommunity.jpg"
                    alt="Communinity Projects Header">
            </div>
        </div>
    </div>
    <?php include 'includes/pages/trailmap-alert.php'; ?>
    <?php
        if (!@include('includes/pages/community_projects.html')) {
            echo '<div class="container-xxl py-5">
	                <div class="container">
                        <div class="text-center mx-auto  fadeInUp" data--delay="0.1s" style="max-width: 500px;">
                            <h1 class="display-6">Community Projects</h1>
                        </div>
                        <div class="row justify-content-center text-center">
                            <span>Community Projects Module Loading ......<br> <small>Error: std-dxQH1</small></span>
                        </div> 
                    </div>
                  </div>
                 ';
    ...
    <script type="text/javascript" src="engine1/slider2.js"></script> 
