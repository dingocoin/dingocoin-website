...
<body>
    ...
    <?php
        if (!@include('includes/pages/trailmap_main.html')) {
            echo '<div class="container-xxl py-5">
	                <div class="container">
                        <div class="text-center mx-auto  fadeInUp" data--delay="0.1s" style="max-width: 500px;">
                            <h1 class="display-6">TrailMap</h1>
                        </div>
                        <div class="row justify-content-center text-center">
                            <span>Trailmap Module Loading ......<br> <small>Error: <small>Error: std-dxQH1</small></span>
                        </div> 
                    </div>
                  </div>
                 ';
