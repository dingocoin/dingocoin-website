...
<head>
    ...
    <title>Dingocoin | Get Involved</title>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/data1/images/hgetinvolved.jpg"
            ...
            echo '<div class="container-xxl py-5">
	                <div class="container">
                        <div class="text-center mx-auto  fadeInUp" data--delay="0.1s" style="max-width: 500px;">
                            <h1 class="display-6">Get Involved</h1>
                        </div>
                        <div class="row justify-content-center text-center">
                            <span>Get Involved Module Loading ......<br> <small>Error: <small>Error: std-dxQH1</small></span>
                        </div> 
                    </div>
                  </div>
                 ';
