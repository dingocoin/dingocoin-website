    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/data1/images/hcontact.jpg"
                    alt="Contact Header">
            </div>
        </div>
    </div>
    <?php
        if (!@include('includes/pages/contact.html')) {
            echo '<div class="container-xxl py-5">
	                <div class="container">
                        ...
                        <div class="row justify-content-center text-center">
                            <span>Contact Module Loading ......<br> <small>Error: std-dxQH1</small></span>
                        </div> 
                    </div>
                  </div>
                 ';
