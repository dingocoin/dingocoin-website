jQuery.fn.Slider = function(am) {
	...
	var b = am.images && (new sliderPreloader(this, am));
	var aQ = au.find("li");
	var z = aQ.length;
	...
	if (!p) {
		...
		if (am.gestures) {
			...
			aB(au, am.gestures == 2, function(k, f, c) {
				...
				var f = /ws_playpause|ws_prev|ws_next|ws_bullets/g.test(k.target.className) || aI(k.target).parents(
					".ws_bullets").get(0);
	...
	if (e) {
		...
		(function() {
			if (!document.getElementById("slider_engine")) {
...
jQuery.fn.Slider.support = {
	...
	transition: (function() {
		var a = document.body || document.documentElement,
			b = a.style;
		return b.transition !== undefined || b.WebkitTransition !== undefined || b.MozTransition !== undefined || b.MsTransition !==
			undefined || b.OTransition !== undefined
	})()
}; 
	...
	function b(l, m, n, f, h, j, o) {
		...
		function p(x, w, v, r) {
			if (typeof w === "object") {
				...
				var s = ["px", "%", "in", "cm", "mm", "pt", "pc", "em", "ex", "ch", "rem", "vh", "vw", "vmin", "vmax", "deg",
					"rad", "grad", "turn"
				];
				var u = "";
				if (typeof w === "string") {
